...
const mockParkingSpots = [
  {
    ...
    available: 12,
    total: 50,
    coordinates: [40.7128, -74.006] as [number, number], // NYC area
  },
  {
    id: 2,
...
export default function ParkingMap() {
  ...
  const getAvailabilityInfo = (available: number, total: number) => {
    const percentage = (available / total) * 100;
    if (percentage > 50)
      return { color: 'text-green-600', status: 'High availability' };
    if (percentage > 20)
      return { color: 'text-orange-600', status: 'Medium availability' };
                ...
                <div className="space-y-3 min-w-[200px]">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`font-semibold ${availabilityInfo.color}`}
                      >
                  ...
                  <div className="pt-2 border-t border-gray-200">
                    <p
                      className={`text-xs ${availabilityInfo.color} font-medium`}
                    >
