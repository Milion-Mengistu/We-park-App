...
var tn = (e, r = new Ti()) => {
    let t = {
      ...
      startTransaction: async (...n) =>
        (await _e(r, e.startTransaction.bind(e))(...n)).map((o) => Jc(r, o)),
    };
    return (
      e.getConnectionInfo &&
        (t.getConnectionInfo = Hc(r, e.getConnectionInfo.bind(e))),
      t
    );
  },
  Jc = (e, r) => ({
...
m.precision = m.sd = function (e) {
  ...
  return (
    t.d ? ((r = Ws(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = NaN),
    r
  );
};
m.round = function () {
...
function zs(e) {
  ...
  function i(o) {
    ...
    if (l === 'bigint')
      return (o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), mn(u, o.toString()));
    throw Error(He + o);
  }
  if (
    ((i.prototype = m),
...
var bd = (e) => e,
  ...
  v = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Ed }),
          e.__id
        );
      },
...
var Ja = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  Ha = (e, r, t) =>
    Ja(r).reduceRight(
      (n, i, o, s) => Object.assign({}, lo(e, s.slice(0, o)), { [i]: n }),
      t
    );
function Nm(e, r) {
...
function pl({ postinstall: e, ciName: r, clientVersion: t }) {
  if (
    (ul('checkPlatformCaching:postinstall', e),
    ul('checkPlatformCaching:ciName', r),
    e === !0 && r && r in cl)
  ) {
...
async function bl(e, r) {
  ...
  if (
    (of('enginePath', n), n !== void 0 && e === 'binary' && Ai(n), n !== void 0)
  )
  ...
  let o = await ir(),
    ...
    p;
  throw (
    a && l ? (p = gl(c)) : l ? (p = ml(c)) : u ? (p = fl(c)) : (p = hl(c)),
...
\`\`\``
      : '',
    c = (0,
    mo.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
${a.backtrace}`,
  ...
  buildQueryError(r, t) {
    ...
    return n
      ? n.error
      : qr(r, this.config.clientVersion, this.config.activeProvider);
  }
