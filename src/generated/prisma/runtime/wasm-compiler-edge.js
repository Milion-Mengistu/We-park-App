...
function Go(e, t) {
  ...
  for (
    t == null ? ((W = !1), (a = C)) : (a = t), s = new A(0.03125);
    e.abs().gte(0.1);

  )
    ((e = e.times(s)), (h += 5));
  for (
    n = ((Math.log(ze(2, h)) / Math.LN10) * 2 + 5) | 0,
      a += n,
      r = i = o = new A(ye),
      A.precision = a;
    ;
...
function Gt(e, t) {
  ...
  if ((t == null ? ((W = !1), (h = L)) : (h = t), R.eq(10)))
    return (t == null && (W = !0), ui(k, h));
  if (
    ((h += S),
    (k.precision = h),
    (r = Re(_)),
  ...
  for (
    a = s = R = Le(R.minus(ye), R.plus(ye), h), A = V(R.times(R), h), i = 3;
    ;

  ) {
    if (
      ((s = V(s.times(A), h)),
      (f = a.plus(Le(s, new k(i), h))),
      Re(f.d).slice(0, h) === Re(a.d).slice(0, h))
    )
      return (
        (a = a.times(2)),
...
function V(e, t, r) {
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                f ||
                (r == 6 &&
                  (n > 0 ? (i > 0 ? h / ze(10, s - i) : 0) : C[A - 1]) % 10 &
                    1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !C[0])
  )
  ...
  if (
    (n == 0
      ...
      : ((C.length = A + 1),
        (o = ze(10, Q - n)),
        (C[A] = i > 0 ? ((h / ze(10, s - i)) % ze(10, i) | 0) * o : 0)),
    f)
  )
    for (;;)
      if (A == 0) {
...
function Wo(e, t) {
  var r,
    ...
    R = S.precision;
  if (!e.s || !t.s)
    return (t.s ? (t.s = -t.s) : (t = new S(e)), W ? V(t, R) : t);
  if (
    ((f = e.d),
    (C = t.d),
    (n = t.e),
...
var mt,
  ...
  Ko = ge(() => {
    ...
    I.logarithm = I.log = function (e) {
      ...
      return r.eq(ye)
        ? new n(0)
        : ((W = !1), (t = Le(Gt(r, o), Gt(e, o), o)), (W = !0), V(t, i));
    };
    I.minus = I.sub = function (e) {
      var t = this;
      return (
        (e = new t.constructor(e)),
        t.s == e.s ? Wo(t, e) : Ho(t, ((e.s = -e.s), e))
      );
    };
    I.modulo = I.mod = function (e) {
      ...
      return r.s
        ? ((W = !1), (t = Le(r, e, 0, 1).times(e)), (W = !0), r.minus(t))
        : V(new n(r), i);
    };
    ...
    I.precision = I.sd = function (e) {
      ...
      if (
        ((t = X(i) + 1), (n = i.d.length - 1), (r = n * Q + 1), (n = i.d[n]), n)
      ) {
        for (; n % 10 == 0; n /= 10) r--;
...
var Dl = se((U) => {
  ...
  function md(e = 32) {
    ...
    if (_t.crypto && typeof _t.crypto.randomBytes == 'function')
      return _t.crypto.randomBytes(e);
...
var Vl = se((G) => {
  ...
  for (let e = 0, t = br, r = 1, n = 0; e < 24; e++) {
    ...
    for (let o = 0; o < 7; o++)
      ((t = ((t << br) ^ ((t >> gd) * hd)) % yd),
        t & fd && (i ^= br << ((br << BigInt(o)) - br)));
    Ul.push(i);
  }
  var [wd, bd] = (0, Er.split)(Ul, !0),
    _l = (e, t, r) =>
      r > 32 ? (0, Er.rotlBH)(e, t, r) : (0, Er.rotlSH)(e, t, r),
    Ml = (e, t, r) =>
      r > 32 ? (0, Er.rotlBL)(e, t, r) : (0, Er.rotlSL)(e, t, r);
  function Fl(e, t = 24) {
  ...
  var xr = class e extends Fe.Hash {
    ...
    digestInto(t) {
      if (((0, Mt.aoutput)(t, this), this.finished))
...
var Au = {
  enabled:
    !Xo && es == null && ts !== 'dumb' && ((gi != null && gi !== '0') || rs),
};
function B(e, t) {
...
function Su(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Wt.push([o, ...n]),
        Wt.length > Cu && Wt.shift(),
        Jt.enabled(o) || i)
      ) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: xp(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n);
  }
...
function $p(e, t) {
  for (let r of t.fields)
    r.isRelation &&
      !e.hasField(r.name) &&
      e.addSuggestion(new he(r.name, 'true'));
}
function Vp(e, t) {
  for (let r of t.fields)
    !e.hasField(r.name) &&
...
function qp(e, t) {
  for (let r of t)
    e.hasField(r.name) ||
      e.addSuggestion(new he(r.name, r.typeNames.join(' | ')));
}
function Gs(e, t) {
  let [r, n] = vt(e),
  ...
  mr = class {
    constructor(t, r) {
      (Ni.set(this, { sql: t, values: r }),
        Object.defineProperty(this, An, { value: An }));
    }
    get sql() {
...
function Ot(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      ya[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} }
  );
  ...
  return await t.runInChildSpan(
    {
      name: 'db_query',
      kind: wr.CLIENT,
      attributes: { 'db.query.text': e.sql, 'db.system.name': Nm(r) },
    },
    async () => {
      let o = new Date(),
        s = b.now(),
...
function Nd(e, t = Xl) {
  ...
  if (e > Yl)
    throw new ot(
      ...
      `Cannot encode a time larger than ${Yl}: ${e}`
    );
  ...
  let r,
    n = '';
  for (let i = t; i > 0; i--)
    ((r = e % vr), (n = Zl.charAt(r) + n), (e = (e - r) / vr));
  return n;
}
function Ud() {
...
var qn = class {
    ...
    snapshot(t) {
      return Object.create(this.#e, {
        now: { value: t === 'mysql' ? new po() : new uo() },
      });
    }
    register(t, r) {
      this.#e[t] = r;
          ...
          case 'parameterTupleList': {
            ...
            return h
              .map((C) => {
                ...
                let S = C.map((R) => (o.push(R), Eo(t, i++))).join(
                  a.itemSeparator
                );
  ...
  async interpretNode(t, r, n, i) {
    switch (t.type) {
      ...
      case 'concat': {
        ...
        return {
          value: o.length > 0 ? o.reduce((s, a) => s.concat(Ar(a)), []) : [],
        };
      }
      case 'sum': {
        let o = await Promise.all(
      ...
      case 'paginate': {
        ...
        if (f !== null) {
          ...
          return (
            ...
            {
              value: A.flatMap(([, C]) => mc(C, t.args.pagination)),
              lastInsertId: s,
            }
          );
        }
    ...
    async closeTransaction(t, r) {
      ...
      try {
        ...
        ((t.status = r),
          ...
          this.closedTransactions.length > zd &&
  ...
  constructor(t, r, n) {
    ...
    if (r) this.#n = { remote: !0 };
      ...
      ((this.#n = { remote: !1, driverAdapterFactory: t.adapter }),
        kr('Using driver adapter: %O', t.adapter));
    else
      throw new F(
        ...
        case 'multi': {
          ...
          return (
            h !== void 0 &&
              r?.kind !== 'itx' &&
              (S
                ? await this.transaction('rollback', {}, h)
                : await this.transaction('commit', {}, h)),
            C
          );
        }
        case 'compacted': {
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          rootEnvPath:
            ...
            tn.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            tn.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = n.adapter;
